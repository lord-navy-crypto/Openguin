...
for token in ['Openguin','Thinking','Streaming playground','Sync official','Hardware Fit 3','Diagnostics & Usage','HUGGING FACE GGUF','Observatory','Runtime Observatory','openguin:task']:
...
for file in ['src/taskCenter.ts','src/task-center.css','src/observatory.css','src/performance09.css','LICENSE','NOTICE.md','THIRD_PARTY_NOTICES.md','COPYRIGHT.md','SECURITY.md','CONTRIBUTING.md','docs/ENGINE_BEHAVIOR.md','docs/MODEL_LICENSING.md']:
